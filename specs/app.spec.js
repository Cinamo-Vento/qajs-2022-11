...
describe("Test of the fullTrim function", () => {
  it.each([
    { text: "Пример объявления функции", expected: "Примеробъявленияфункции" },
...
describe("Test of the getTotal function", () => {
  it.each([
    ...
    { item: [{ price: 10, quantity: 3 }, { price: 70, quantity: 1 }], discount: 5, expected: 95 },
  ])(
  ...
  it.each([
    ...
    { item: [{ price: 100, quantity: 9 }, { price: 50, quantity: 2 }], expected: 1000 },
  ...
  ])("Catch an invalid discount $discount", ({ item, discount, expected }) => {
    expect(() => {
